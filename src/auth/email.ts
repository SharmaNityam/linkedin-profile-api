...
/**
 * The stable identity of an address: what we store, index and compare on so a
 * single mailbox cannot register twice under different spellings.
 */
...
/** The lowercase domain of an address, after canonicalisation. */
export function emailDomain(email: string): string {
  return canonicalEmail(email).split('@')[1]!;
}
